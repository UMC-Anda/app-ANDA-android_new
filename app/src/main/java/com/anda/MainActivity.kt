...
class MainActivity : AppCompatActivity() {
    ...
    private fun setReviews() {
        ...
        ophthaSharedPreferences1_lasik.edit().putFloat("totalRating",totalAvg.toFloat())
        ...
        ophthaSharedPreferences7_lasik_review4.edit()
            ...
            .apply()
        totalAvg = (5+6+9+5) / 4f
        ophthaSharedPreferences7_lasik.edit().putFloat("totalRating",totalAvg.toFloat())
        ...
        ophthaSharedPreferences12_lasik_review4.edit()
            ...
            .apply()
        totalAvg = (6+6+9+7) / 4f
        ophthaSharedPreferences12_lasik.edit().putFloat("totalRating",totalAvg.toFloat())
        ...
        ophthaSharedPreferences17_lasik_review4.edit()
            ...
            .apply()
        totalAvg = (6+7+8+4) / 4f
        ophthaSharedPreferences17_lasik.edit().putFloat("totalRating",totalAvg.toFloat())
        ...
        ophthaSharedPreferences2_lasek_review3.edit()
            ...
            .apply()
        totalAvg = (6+6+5) / 3f
        ophthaSharedPreferences2_lasek.edit().putFloat("totalRating",totalAvg.toFloat())
        ...
        ophthaSharedPreferences8_lasek_review3.edit()
            ...
            .apply()
        totalAvg = (6+7+8) / 3f
        ophthaSharedPreferences8_lasek.edit().putFloat("totalRating",totalAvg.toFloat())
        ...
        ophthaSharedPreferences13_lasek.edit().putFloat("totalRating",totalAvg.toFloat())
        ...
        ophthaSharedPreferences18_lasek_review4.edit()
            ...
            .apply()
        totalAvg =  (5+6+9+6)/ 4f
        ophthaSharedPreferences18_lasek.edit().putFloat("totalRating",totalAvg.toFloat())
        ...
        ophthaSharedPreferences3_smile.edit().putFloat("totalRating",totalAvg.toFloat())
