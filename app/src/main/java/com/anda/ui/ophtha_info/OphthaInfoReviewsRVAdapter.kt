    ...
    inner class ViewHolder(val binding: ItemOphthaInfoReviewBinding) :
        ...
        fun bind(ophthaInfoReview: ExOphthaInfoReview) {
            ...
            when (ophthaInfoReview.operationCategory) {
                "lasik" -> {
                    binding.itemOphthaInfoReviewCategoryTv.text = "라식"
                    binding.itemOphthaInfoReviewPriceCategoryTv.text = "라식"
                }
                "lasek" -> {
                    binding.itemOphthaInfoReviewCategoryTv.text = "라섹"
                    binding.itemOphthaInfoReviewPriceCategoryTv.text = "라섹"
                }
                "smile" -> {
                    binding.itemOphthaInfoReviewCategoryTv.text = "스마일 라식"
                    binding.itemOphthaInfoReviewPriceCategoryTv.text = "스마일 라식"
                }
                "today" -> {
                    binding.itemOphthaInfoReviewCategoryTv.text = "투데이 라섹"
                    binding.itemOphthaInfoReviewPriceCategoryTv.text = "투데이 라섹"
                }
                "lens" -> {
                    binding.itemOphthaInfoReviewCategoryTv.text = "렌즈삽입술"
                    binding.itemOphthaInfoReviewPriceCategoryTv.text = "렌즈삽입술"
                }
                "back" -> {
                    binding.itemOphthaInfoReviewCategoryTv.text = "백내장"
                    binding.itemOphthaInfoReviewPriceCategoryTv.text = "백내장"
                }
            }
