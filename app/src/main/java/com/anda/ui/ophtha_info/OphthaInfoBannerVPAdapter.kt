...
class OphthaInfoBannerVPAdapter(fragment:Fragment, val ophthaInfoEventDatas:ArrayList<OphthaInfoEvent>?, val ophthaInfoReviewDatas:ArrayList<OphthaInfoReview>?) : FragmentStateAdapter(fragment){
